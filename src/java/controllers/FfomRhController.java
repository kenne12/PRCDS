...
public class FfomRhController implements Serializable {
    ...
    @EJB
    private FfomRegionFacadeLocal ffomRegionFacadeLocal1;

    @EJB
    private PilierFacadeLocal pilierFacadeLocal;
    ...
    private void init() {
        try {
            ...
            List<FfomRegion> ffoms = ffomRegionFacadeLocal1.find(SessionMBean.getRegion(), pilier);
            if (!ffoms.isEmpty()) {
                System.err.println("ffom trouvé");
    ...
    public void updateForce() throws Exception {
        ...
        try {
            ...
            /*List<FfomRegion> ffoms = ffomRegionFacadeLocal1.find(SessionMBean.getRegion(), pilier);
             ...
             ffomRegionFacadeLocal1.edit(ffomRegion);
             }*/
    ...
    public void updateFaiblesse() throws Exception {
        try {
            ...
            if (!temp.isEmpty()) {
                ...
                System.err.println("on est en update faiblesse");
                System.err.println("taille faiblesse : " + temp.size());
                ...
                System.err.println("menace empty");
            }
    ...
    public void createFfom() {
        try {
            ...
            if (ffomRegion != null) {
                if (pilier != null) {
                    ffomRegion.setIdffomRegion(ffomRegionFacadeLocal1.nextId());
                    ...
                    ffomRegionFacadeLocal1.create(ffomRegion);
